...
import { MobileSenderidCotentBlackList_ApiResponse, MobileSenderidContentBlackList_AddResponse, MobileSenderidBlackList_DeleteResponse } from '../../../models/BlackList/blacklist.model';
...
export class BlackListAddMobileSenderidService {
   ...
   */
  addBlSender(body, formType): Observable<MobileSenderidContentBlackList_AddResponse> {
    let values: any;
    if(formType){
      values = body
